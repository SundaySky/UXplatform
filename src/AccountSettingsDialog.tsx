...
function SeatHeader({ label, iconTooltip, chipTooltip, used, total }: { label: string; iconTooltip?: string; chipTooltip?: string; used: number; total: number }) {
 ...
 <Typography variant="subtitle2" sx={{ color: "text.primary", cursor: "default"}}>{label}</Typography>
 {iconTooltip ? (
 <Tooltip title={iconTooltip} placement="top" arrow componentsProps={{ tooltip: { sx: { bgcolor: "secondary.main" } } }}>
 <InfoOutlinedIcon sx={{ fontSize: 14, color: "action.active", cursor: "default" }} />
 </Tooltip>
 ) : (
 <InfoOutlinedIcon sx={{ fontSize: 14, color: "action.active", cursor: "default" }} />
 )}
 ...
 <Box sx={{ bgcolor: "action.hover", borderRadius: "4px", px: "6px", py: "2px", cursor: "default" }}>
 <Typography variant="caption" sx={{ color: "primary.main"}}>{used}/{total}</Typography>
 </Box>
 </Tooltip>
 </Box>
 );
...
function CreateSpaceSelector({
 ...
 {description && (
 <Typography variant="caption" sx={{ color: "text.secondary", mt: "2px", lineHeight: 1.4}}>
 {description}
 </Typography>
 )}
 </Box>
...
function UserCell({ row }: { row: AccountUser }) {
 ...
 <Avatar sx={{ width: 32, height: 32, bgcolor: "secondary.main", fontSize: 11, fontWeight: 600, flexShrink: 0, borderRadius: "8px" }}>
 {row.user.initials}
 </Avatar>
 <Box sx={{ minWidth: 0 }}>
 <Typography variant="subtitle2" sx={{ color: "text.primary", lineHeight: 1.3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"}}>
 {row.user.name}
 </Typography>
 <Typography variant="caption" sx={{ color: "text.secondary", lineHeight: 1.3, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"}}>
 {row.jobRole}
 </Typography>
 </Box>
 </Box>
...
function AddUserDialog({ open, onClose, onSend, users, asApprover = false, onEditExistingUser }: {
 ...
 <IconButton size="small" onClick={onClose} sx={{ color: "action.active" }}><CloseIcon sx={{ fontSize: 18 }} /></IconButton>
 </Box>
 ...
 sx={{ height: 40, mb: "16px", "& .MuiOutlinedInput-notchedOutline": { borderColor: "grey.300" } }}
 />
 ...
 sx={{ bgcolor: "primary.main", boxShadow: "none", "&:hover": { bgcolor: "#0047C8", boxShadow: "none" } }}
 >
 Edit user type
 </Button>
 </Box>
 ...
 <Box>
 <Typography variant="caption" sx={{ color: "text.secondary", mb: "6px", textTransform: "uppercase", letterSpacing: "0.5px"}}>Email</Typography>
 <OutlinedInput
 placeholder="user@example.com"
 value={row.email}
 ...
 fullWidth
 sx={{ height: 40, "& .MuiOutlinedInput-notchedOutline": { borderColor: row.emailError ? "#F87171" : "grey.300" } }}
 />
 {row.emailError && (
 <Typography variant="caption" sx={{ color: "#F87171", mt: "4px"}}>
 {row.emailError}
 </Typography>
 )}
 </Box>
 ...
 <MenuItem key={o} value={o} sx={{ py: "12px" }}>
 ...
 {/* Info box */}
 <Box sx={{ display: "flex", alignItems: "flex-start", gap: "8px", bgcolor: "action.hover", borderRadius: "8px", px: "14px", py: "12px", mb: "20px" }}>
 <InfoOutlinedIcon sx={{ fontSize: 16, color: "primary.main", mt: "1px", flexShrink: 0 }} />
 <Typography variant="body1" sx={{ color: "text.primary"}}>
 ...
 <Box>
 <Typography variant="subtitle2" sx={{ color: "text.primary", mb: "2px"}}>
 No seats available
 </Typography>
 <Typography variant="body1" sx={{ color: "text.primary"}}>
 ...
 sx={{ bgcolor: "primary.main", boxShadow: "none", "&:hover": { bgcolor: "#0047C8", boxShadow: "none" }, "&.Mui-disabled": { bgcolor: "grey.300", color: "common.white", boxShadow: "none" } }}
 >
 Add users
 </Button>
 </Box>
 ...
 <Typography variant="h4" sx={{ color: "text.primary"}}>No seats available</Typography>
 <IconButton size="small" onClick={() => setNoSeatsOpen(false)} sx={{ color: "action.active" }}><CloseIcon sx={{ fontSize: 18 }} /></IconButton>
 </Box>
 ...
 <Box sx={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
 <Button variant="outlined" onClick={() => setNoSeatsOpen(false)} sx={{ color: "text.primary", borderColor: "grey.300" }}>
 Close
 </Button>
 <Button variant="contained" sx={{ bgcolor: "primary.main", boxShadow: "none", "&:hover": { bgcolor: "#0047C8", boxShadow: "none" } }}>
 Contact sales
 </Button>
 </Box>
 </Box>
...
function AddApproverDialog({ open, onClose, onAdd, allUsers, existingApproverIds = [], onOpenAddUser }: {
 ...
 sx={{ color: "primary.main", p: 0, "&:hover": { bgcolor: "transparent", textDecoration: "underline" } }}
 >
 Add new user
 </Button>
 ...
 <IconButton size="small" onClick={() => setSeatConfirmOpen(false)} sx={{ color: "action.active" }}>
 <CloseIcon sx={{ fontSize: 18 }} />
 </IconButton>
 </Box>
 ...
 <IconButton size="small" onClick={() => setNewUserConfirmOpen(false)} sx={{ color: "action.active" }}>
 <CloseIcon sx={{ fontSize: 18 }} />
 </IconButton>
 </Box>
...
function DeleteUserDialog({ open, onClose, userName, onConfirm }: {
 ...
 <Box sx={{ px: "24px", py: "20px" }}>
 {/* Title */}
 <Typography variant="h4" sx={{ color: "text.primary", mb: "12px"}}>
 Remove user
 </Typography>
 ...
 sx={{ bgcolor: "error.main", boxShadow: "none", "&:hover": { bgcolor: "error.dark", boxShadow: "none" } }}
 >
 Remove
 </Button>
 </Box>
...
function ApprovalsSection({ users, approverIds, enabled, onToggle, onSetApprovers, onAddUsers, onPermissionsChanged, pendingApprovalsCount = 0, videoStates = {} }: {
 ...
 {/* Toggle row */}
 <Box sx={{ border: 1, borderColor: "grey.300", borderRadius: "10px", overflow: "hidden", flexShrink: 0 }}>
 <Box sx={{ display: "flex", alignItems: "center", gap: "12px", px: "16px", py: "14px" }}>
 <ApprovalOutlinedIcon sx={{ fontSize: 22, color: "primary.main", flexShrink: 0 }} />
 ...
 sx={{ "& .MuiSwitch-switchBase.Mui-checked": { color: "common.white" }, "& .MuiSwitch-switchBase.Mui-checked + .MuiSwitch-track": { bgcolor: "primary.main" } }}
 />
 </Box>
 ...
 : { bgcolor: "primary.main", boxShadow: "none", color: "common.white", "&:hover": { bgcolor: "#0047C8", boxShadow: "none" } }
 )
 }}
 >
 Add approver
 ...
 startAdornment={<InputAdornment position="start"><SearchIcon sx={{ fontSize: 14, color: "action.active" }} /></InputAdornment>}
 sx={{ width: 200, "& .MuiOutlinedInput-notchedOutline": { borderColor: "grey.300" } }}
 />
 </Box>

 {/* Approvers table or empty state */}
 {approvers.length === 0 ? (
 <Box sx={{ bgcolor: "grey.100", borderRadius: "8px", py: "20px", display: "flex", alignItems: "center", justifyContent: "center" }}>
 <Typography variant="body1" sx={{ color: "text.secondary"}}>
 Add approver to change this permission
 </Typography>
 </Box>
 ) : (
 <Box sx={{ borderRadius: "8px", border: 1, borderColor: "grey.300", overflow: "auto", maxHeight: 300 }}>
 <Table size="small" sx={{ width: "100%" }}>
 <TableHead>
 <TableRow>
 <TableCell sx={{ ...headCellSx, width: 220, position: "sticky", left: 0, zIndex: 4 }}>
 <Box sx={{ display: "flex", alignItems: "center", gap: "4px" }}>
 User <ArrowDownwardIcon sx={{ fontSize: 13, color: "action.active" }} />
 </Box>
 </TableCell>
 ...
 sx={{ color: "text.primary", p: "4px", "&:hover": { bgcolor: "grey.100" } }}
 >
 ...
 <Typography variant="caption" sx={{ color: "text.secondary", minWidth: 90}}>{label}:</Typography>
 ...
 sx={{ color: "error.main", px: "16px", py: "8px", gap: "10px" }}
 >
 ...
 <Typography variant="h4" sx={{ color: "text.primary", mb: "16px"}}>
 ...
 >
 <Box sx={{ width: 64, height: 48, borderRadius: "6px", bgcolor: "#E8ECF4", flexShrink: 0, border: 1, borderColor: "grey.300", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
 ...
 {v.sentAt && (
 <Typography variant="caption" sx={{ color: "text.secondary", mb: "4px"}}>
 ...
 <Typography variant="caption" sx={{ color: "warning.main", mt: "2px"}}>
 Awaiting approval
 </Typography>
 </Box>
 </Box>
 ...
 <Box sx={{ display: "flex", justifyContent: "flex-end", px: "24px", py: "16px", borderTop: 1, borderTopColor: "grey.300" }}>
 <Button
 variant="contained"
...
function UsersSection({
 ...
 variant="outlined"
 onClick={() => setDialogMode("add")}
 sx={{ px: "16px", py: "7px", color: "primary.main", borderColor: "grey.300", "&:hover": { bgcolor: "action.hover", borderColor: "primary.main", boxShadow: "none" } }}
 >
 Add user
 </Button>
 <OutlinedInput
 ...
 value={search}
 onChange={e => setSearch(e.target.value)}
 startAdornment={<InputAdornment position="start"><SearchIcon sx={{ fontSize: 16, color: "action.active" }} /></InputAdornment>}
 sx={{ width: 220, "& .MuiOutlinedInput-notchedOutline": { borderColor: "grey.300" }, "&:hover .MuiOutlinedInput-notchedOutline": { borderColor: "grey.300" } }}
 />
 </Box>
 </Box>

 {/* Table */}
 <Box sx={{ flex: 1, overflowX: "auto", overflowY: "auto", borderRadius: "8px", border: 1, borderColor: "grey.300" }}>
 <Table size="small" sx={{ width: "100%" }}>
 <TableHead>
 <TableRow>
 <TableCell sx={{ ...headCellSx, width: 220, position: "sticky", left: 0, zIndex: 4 }}>
 <Box sx={{ display: "flex", alignItems: "center", gap: "4px", cursor: "pointer" }}>
 User <ArrowDownwardIcon sx={{ fontSize: 14, color: "action.active" }} />
 </Box>
 </TableCell>
 <TableCell sx={{ ...headCellSx }}>
 <SeatHeader
 ...
 }} sx={{ color: "primary.main", "&:hover": { bgcolor: "action.hover" }, p: "4px" }}>
 ...
 <Box sx={{ bgcolor: "action.hover", borderRadius: "8px", px: "14px", py: "12px", mb: "24px" }}>
 ...
 >
 <Box sx={{ px: "24px", pt: "20px", pb: "8px" }}>
 <Typography variant="h4" sx={{ color: "text.primary", mb: "8px"}}>
 Cannot remove this user
 </Typography>
 <Typography variant="body1" sx={{ color: "text.secondary", mb: "16px", lineHeight: 1.6}}>
 ...
 <Box key={label} sx={{ display: "flex", gap: "6px" }}>
 <Typography variant="caption" sx={{ color: "text.secondary", minWidth: 80}}>{label}:</Typography>
 <Typography variant="body1" sx={{ color: "text.primary"}}>{value}</Typography>
 </Box>
 ))}
 </Box>,
 ...
 sx={{ color: "text.primary", px: "16px", py: "8px", gap: "10px" }}
 >
 <EditOutlinedIcon sx={{ fontSize: 16, color: "action.active" }} />
 Edit access
 </MenuItem>,
 <MenuItem
 key="remove"
...
export default function AccountSettingsDialog({
 ...
 >
 {/* Title bar */}
 <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", px: "24px", py: "14px", borderBottom: 1, borderBottomColor: "grey.300", flexShrink: 0 }}>
 <Typography variant="h3" sx={{ color: "text.primary"}}>Account settings</Typography>
 <Box sx={{ display: "flex", alignItems: "center", gap: "4px" }}>
 <IconButton size="small" sx={{ color: "action.active" }}><HelpOutlineIcon sx={{ fontSize: 18 }} /></IconButton>
 <IconButton size="small" onClick={() => {
 ...
 }} sx={{ color: "action.active" }}><CloseIcon sx={{ fontSize: 18 }} /></IconButton>
 </Box>
 </Box>
 ...
 {/* Sidebar */}
 <Box sx={{ width: 176, flexShrink: 0, borderRight: 1, borderRightColor: "grey.300", py: "12px", px: "8px", display: "flex", flexDirection: "column", gap: "2px", bgcolor: "#FAFBFD" }}>
 {NAV.map(item => (
 <Box
 key={item.key}
 onClick={() => {
