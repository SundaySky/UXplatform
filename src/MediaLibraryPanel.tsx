...
// ─── Design tokens (mirrors StudioPage s object) ──────────────────────────────
const c = {
  primary:       '#0053E5',
...
// ─── Tooltip sx for navy background ──────────────────────────────────────────
const navyTooltipSx = {
  bgcolor: '#03194F',
  borderRadius: '8px',
  px: 1.5,
...
// ─── White icon button used on hover overlay ──────────────────────────────────
...
// ─── Permission section shown inside the three-dot menu ──────────────────────
function PermissionSection() {
  const ownerTooltip = (
    <Box>
      ...
      <Typography sx={{ fontSize: 12, color: 'rgba(255,255,255,0.75)', lineHeight: 1.5 }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        >
          <Avatar
            ...
            sx={{
              width: 32, height: 32,
              bgcolor: c.secondary, cursor: 'default',
            }}
          >
...
export default function MediaLibraryPanel({
  ...
  return (
    <Box sx={{
      ...
      {/* Fixed-width inner container — never shrinks during animation */}
      <Box sx={{
        width:         PANEL_WIDTH,
        flexShrink:    0,
        height:        '100%',
            ...
            <Button
              ...
              startIcon={
                <Box sx={{
                  ...
                  bgcolor: c.errorMain, flexShrink: 0,
                }} />
              }
              sx={{
          ...
          <Box sx={{
            ...
            <Box
              ...
              sx={{
                ...
                bgcolor: viewMode === 'grid' ? c.primarySel : 'transparent',
            ...
            <Box
              ...
              sx={{
                p: '4px', display: 'flex', alignItems: 'center', cursor: 'pointer',
                bgcolor: viewMode === 'list' ? c.primarySel : 'transparent',
                borderRadius: '6px', transition: 'background 0.15s',
              }}
            >
        ...
        <Box sx={{ flex: 1, overflowY: 'auto', px: 2 }}>
          ...
          {/* Folder strip — only shown when navigated into a folder */}
          {folder && (
            <Box sx={{ mb: 1.5, pt: 0.5 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 0.5 }}>
                <IconButton
                  ...
                  sx={{ color: c.actionActive, mr: '4px', p: '4px' }}
                >
          ...
          <Box sx={{
            ...
            {/* Folder items — only at root level */}
