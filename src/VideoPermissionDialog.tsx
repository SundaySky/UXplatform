                    ...
                    return (
                        <Box key={key} component="li" {...listProps} sx={{ display: "flex", alignItems: "center", gap: 1.5, px: 1.5, py: 1 }}>
                            <Avatar variant="rounded" sx={{
                                width: 36, height: 36, bgcolor: c.primaryLight, fontSize: 12,
                                fontFamily: "\"Inter\"", fontWeight: 600, flexShrink: 0, color: c.textPrimary
                            }}>
                                {option.initials}
                            </Avatar>
                            <Box sx={{ flex: 1, minWidth: 0 }}>
    ...
    return (
        <>
                                    ...
                                    <>
                                        ...
                                        <Box sx={{ display: "flex", alignItems: "center", gap: "12px", px: "16px", py: "10px" }}>
                                            <Box sx={{
                                                ...
                                                bgcolor: everyoneRole === "restricted" ? "rgba(0,0,0,0.06)" : c.primaryLight,
            ...
            Keep editing
                    ...
                    sx={{
                        bgcolor: c.errorMain, fontFamily: "\"Open Sans\", sans-serif",
                        textTransform: "none", fontWeight: 600, borderRadius: "8px",
                        boxShadow: "none", "&:hover": { bgcolor: "#C41C32", boxShadow: "none" }
                    }}>
            Discard
                    </Button>
                </DialogActions>
